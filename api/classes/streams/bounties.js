...
io.on('connection', function (socket) {
	  ...
	  socket.on('load_next_bounty', function(data){
	  	socket.broadcast.emit('load_next_bounty', data)
	  })

	  socket.on('automode_on', function(data){
	  	socket.broadcast.emit('automode_on', data)
	  })

	  socket.on('automode_off', function(data){
	  	socket.broadcast.emit('automode_off', data)
	  })

	  socket.on('reload_script', function(data){
	  	socket.broadcast.emit('reload_script', data)
	  });

	  socket.on('portrait', function(data){
	  	socket.broadcast.emit('portrait', data)
	  });

	  socket.on('portraitUpsideDown', function(data){
	  	socket.broadcast.emit('portraitUpsideDown', data)
	  });

	  socket.on('landscapeLeft', function(data){
	  	socket.broadcast.emit('landscapeLeft', data)
	  });

	  socket.on('landscapeRight', function(data){
	  	socket.broadcast.emit('landscapeRight', data)
	  });
